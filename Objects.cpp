...
Vector Plane::getCenter() {
    perror("something's wrong! called getCenter on Plane!");
    return point1;
}

Vector Plane::getFarthest(Vector v) {
    perror("something's wrong! called getFarthest on Plane!");
    return point1;
}

Vector Plane::hiCorner() {
    perror("something's wrong! called hiCorner on Plane!");
    return point1;
}

Vector Plane::loCorner() {
    perror("something's wrong! called loCorner on Plane!");
    return point1;
}
